...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jquery__ = __webpack_require__(1);
...
function load(url, cb) {
    __WEBPACK_IMPORTED_MODULE_0__jquery__["ajax"](url).
        done(function(data) {
...
function _copyInto(src, dest, copyInnerHTML) {
    ...
    var destElem = __WEBPACK_IMPORTED_MODULE_0__jquery__(dest)
    __WEBPACK_IMPORTED_MODULE_0__jquery__(src).each((_, srcElem) => {
        __WEBPACK_IMPORTED_MODULE_0__jquery__["each"](srcElem.attributes, (_, srcAttr) => {
...
function _traverseElement(elem) {
    if (elem.nodeType == Node.ELEMENT_NODE && elem.getAttribute("thw:ref")) {
        ...
        var src = __WEBPACK_IMPORTED_MODULE_0__jquery__("[thw\\:id=\'"+ref+"\']");
        if (src.length > 0) {     
            var elemClone = null
            if (src.length > 1) {
                elemClone = __WEBPACK_IMPORTED_MODULE_0__jquery__(elem).clone()
            }  
            var toInsert = []     
            ...
            if (toInsert.length > 0) {
                __WEBPACK_IMPORTED_MODULE_0__jquery__(elem).after(toInsert)                
            }
        }
