...
/* harmony import */ var _jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
function load(url, cb) {
    _jquery__WEBPACK_IMPORTED_MODULE_0__["ajax"](url).
        done(function(data) {
...
function _copyInto(src, dest, copyInnerHTML) {
    ...
    var destElem = _jquery__WEBPACK_IMPORTED_MODULE_0__(dest)
    _jquery__WEBPACK_IMPORTED_MODULE_0__(src).each((_, srcElem) => {
        _jquery__WEBPACK_IMPORTED_MODULE_0__["each"](srcElem.attributes, (_, srcAttr) => {
...
function _traverseElement(elem) {
    if (elem.nodeType == Node.ELEMENT_NODE && elem.getAttribute("thw:ref")) {
        ...
        var src = _jquery__WEBPACK_IMPORTED_MODULE_0__("[thw\\:id=\'"+ref+"\']");
        if (src.length > 0) {     
            var elemClone = null
            if (src.length > 1) {
                elemClone = _jquery__WEBPACK_IMPORTED_MODULE_0__(elem).clone()
            }  
            var toInsert = []     
            ...
            if (toInsert.length > 0) {
                _jquery__WEBPACK_IMPORTED_MODULE_0__(elem).after(toInsert)                
            }
        }
